...
class MapViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate, ARGhostNodeDelegate, GhostModelsDelegate, GhostModelDelegate {
    ...
    let defaultFileNames: [String] = ["model1", "model2", "model3", "model4", "model5", "model6", "model7", "model8", "model1", "model2", "model3", "model4", "model5", "model6", "model7", "model8", "model1", "model2", "model3", "model4", "model5"]
    ...
    let dod: [String] = ["dod1","dod2","dod3","dod4","dod5","dod6","dod7","dod8","dod9","dod10","dod11","dod12","dod13","dod14","dod15","dod16","dod17","dod18","dod19"]
    ...
    let pinIcons: [String] = ["pinIcon1",
                              ...
                              "pinIcon18",
                              "pinIcon19",]
    let profilePicNames: [String] = ["profilePic1", "profilePic2", "profilePic3", "profilePic4", "profilePic5", "profilePic6", "profilePic7", "profilePic8", "profilePic9", "profilePic10", "profilePic11", "profilePic12", "profilePic13", "profilePic14", "profilePic15", "profilePic16", "profilePic17", "profilePic18", "profilePic19"]
